...
@onready var tab_container: TabContainer = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer

@onready var save_button = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/SaveButton

# Options dropdowns
@onready var screen_option_button: OptionButton = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/MonitorContainer/MonitorButton
@onready var window_mode_option = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/WindowModeContainer/WindowModeButton
@onready var resolution_option = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/ResolutionContainer/ResolutionOptionButton
@onready var msaa_option = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/MSAAContainer/MSAAOptionButton
@onready var fsr_option = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/FSRContainer/FSROptionButton

# Check boxes
@onready var fxaa_checkbox = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/AAContainer/FXAACheckBox
@onready var taa_checkbox = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/AAContainer/TAACheckBox
@onready var vysnc_checkbox = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/AAContainer/VSyncCheckBox
@onready var scale_3d_slider = $"PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/3DScaleContainer/3DScaleSlider"

# 3D Scale slider label
@onready var scale_3d_label = $"PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Graphics/VBoxContainer/3DScaleContainer/Scale3DLabel"

# Audio
@onready var master_volume: VolumeSlider = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/MasterSlider
@onready var music_volume: VolumeSlider = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/MusicSlider
@onready var sfx_volume: VolumeSlider = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/SFXSlider
@onready var voice_volume: VolumeSlider = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/VoiceSlider
@onready var voice_button = $PanelContainer/VBoxContainer2/CenterContainer/VBoxContainer/TabContainer/Audio/VBoxContainer/VoiceContainer/VoiceButton
...
func save_settings():
	...
	settings_data.voice = voice_button.selected
...
func load_settings():
	if settings_data != null:
		...
		if OS.get_name() != "Web":
			...
			_on_voice_button_item_selected(settings_data.voice)

			voice_button.selected = settings_data.voice

			if settings_data.voice > 0:
				TTS.setVoice(settings_data.voice - 1)
			else:
				TTS.setVoice(0)
		else:
			voice_button.selected = 0
			TTS.setVoice(0)
...
func load_settings_from_storage():
	if not DirAccess.dir_exists_absolute(save_settings_path):
...
# You can swap themes by passing the path to the theme .tres file, 
# and set the tab container size if you need more space, 
# and you can set a self modulate colour for the tab container.
